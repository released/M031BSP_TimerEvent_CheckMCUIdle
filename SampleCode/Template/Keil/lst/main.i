...
# 9 "../main.c" 2
# 1 "..\\cpu_load_monitor.h" 1
# 34 "..\\cpu_load_monitor.h"
typedef struct _mcu_idle_manager_t
{
 uint32_t idle_counter;
 uint32_t idle_max;
 uint32_t cpu_load_permil;
 uint16_t timer_id_cpumon;
}MCU_IDLE_MANAGER_T;

extern volatile MCU_IDLE_MANAGER_T g_MCUIdleManager;
# 57 "..\\cpu_load_monitor.h"
...
uint8_t check_reset_source(void)
{
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->RSTSTS |= 0x1FF;
...
{
    if(TIMER_GetIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020))) == 1)
    {
        TIMER_ClearIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020)));
  tick_counter();
...
{
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020)), (1UL << (27)), 1000);
    TIMER_EnableInt(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020)));
    __NVIC_EnableIRQ(TMR1_IRQn);
    TIMER_Start(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50020)));
}
...
{
 uint8_t res = 0;
 res = ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->DAT);
...
{
    if((((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->INTSTS & ((0x1ul << (8)) | (0x1ul << (12))))?1:0))
    {
        while(((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->FIFOSTS & (0x1ul << (14))) == 0)
        {
   UARTx_Process();
        }
    }
...
void UART0_Init(void)
{
    ...
    UART_EnableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), (0x1ul << (0)) | (0x1ul << (4)));
...
void GPIO_Init (void)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH & ~((0xful << (24)))) | ((0x00UL<<(24)));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH & ~((0xful << (28)))) | ((0x00UL<<(28)));

    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)), (0x00004000UL), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)), (0x00008000UL), 0x1UL);
...
# 410 "../main.c"
    ...
    CLK_EnableModuleClock(((((1) & 0x03UL) << 30)|((((3)) & 0x1fUL) << 0) | (((1) & 0x03UL) << 28)|(((7) & 0x07UL) << 25)|((((12)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)));
   CLK_SetModuleClock(((((1) & 0x03UL) << 30)|((((3)) & 0x1fUL) << 0) | (((1) & 0x03UL) << 28)|(((7) & 0x07UL) << 25)|((((12)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x7UL<<(12)), 0);
...
int main()
{
 ...
 TIMER1_Init();
    ...
    g_MCUIdleManager.timer_id_cpumon = TimerService_CreateTimer(1000U,
    ...
    if (g_MCUIdleManager.timer_id_cpumon >= 0)
    {
        ...
        printf("cpu monitor timer id = %d\r\n", g_MCUIdleManager.timer_id_cpumon);
    }


    g_timer_id_task1 = TimerService_CreateTimer(1000U, Task1_Callback, (void *)0);
    ...
    g_timer_id_task2 = TimerService_CreateTimer(2000U, Task2_Callback, (void *)0);
    ...
    g_timer_id_task3 = TimerService_CreateTimer(100U, Task3_Callback, (void *)0);
    ...
    g_timer_id_task4 = TimerService_CreateTimer(250U, Task4_Callback, (void *)0);
    ...
    g_timer_id_task5 = TimerService_CreateTimer(1000U, Task5_Callback, (void *)0);
